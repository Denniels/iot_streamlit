# IoT Streamlit - Sistema de Monitoreo IoT
...
├── secrets.toml                 # Configuración (no versionado en producción)
├── docker-compose.yml          # Configuración Docker
├── Dockerfile                  # Imagen Docker
├── main.py                     # Punto de entrada principal
├── acquire_data.py             # Adquisición de datos de sensores
├── db_writer.py                # Escritura a base de datos
├── sync_local_db.py            # Sincronización de BD local
├── start_cloudflare.py         # Inicio del túnel Cloudflare
├── arduino/                    # Código Arduino y documentación
├── arduino_usb_sensor_corrected/ # Código Arduino USB corregido
├── backend/                    # API REST y lógica de backend
├── frontend/                   # Aplicación Streamlit
├── database/                   # Esquemas y scripts de BD
├── services/                   # Archivos systemd para servicios
├── scripts/                    # Scripts de utilidades y diagnóstico
├── docs/                       # Documentación adicional
├── test/                       # Tests y verificaciones
