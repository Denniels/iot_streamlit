...
HEALTH_CHECK_INTERVAL = 45  # 45 segundos (optimizado para Jetson)
MAX_RESTART_ATTEMPTS = 5    # Máximo 5 reintentos
INITIAL_RETRY_DELAY = 10    # Delay inicial: 10s
MAX_RETRY_DELAY = 120       # Delay máximo: 2 minutos
TUNNEL_STARTUP_TIMEOUT = 60 # Timeout para detectar URL del túnel
...
class CloudflareTunnelManager:
    ...
    def _check_tunnel_health(self) -> bool:
        ...
        try:
            ...
            response = requests.get(tunnel_health_url, timeout=15)
