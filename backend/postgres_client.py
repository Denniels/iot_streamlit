...
class PostgreSQLClient:
    ...
    def insert_sensor_data(self, sensor_data: Dict[str, Any]) -> bool:
        ...
        try:
            query = """
            INSERT INTO sensor_data_clean (device_id, sensor_type, value, unit, raw_data)
    ...
    def initialize_schema(self) -> bool:
        ...
        try:
            ...
            CREATE INDEX IF NOT EXISTS idx_sensor_data_device_id ON sensor_data_clean(device_id);
            CREATE INDEX IF NOT EXISTS idx_sensor_data_timestamp ON sensor_data_clean(timestamp);
